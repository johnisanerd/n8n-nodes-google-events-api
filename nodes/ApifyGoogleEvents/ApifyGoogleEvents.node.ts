...
import { properties } from './ApifyGoogleEvents.properties';
import { runActor } from './helpers/executeActor';

// SNIPPET 1: Make sure the constants are correct
export const ACTOR_ID = 'DfdUgh7nBLKe78irv' as string;

export const PACKAGE_NAME = 'n8n-nodes-google-events-api' as string;
export const CLASS_NAME = 'ApifyGoogleEvents' as string;
...
export const X_PLATFORM_APP_HEADER_ID = 'google-events-app' as string;

export const DISPLAY_NAME = 'Google Events' as string;
export const DESCRIPTION =
	'Search Google Events and return event titles, dates, venues, addresses, and ticket links' as string;

export class ApifyGoogleEvents implements INodeType {
